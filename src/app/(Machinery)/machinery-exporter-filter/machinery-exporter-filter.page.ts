...
@Component({
  selector: 'app-machinery-exporter-filter',
  templateUrl: './machinery-exporter-filter.page.html',
  styleUrls: ['./machinery-exporter-filter.page.scss'],
  standalone:false,
})
export class MachineryExporterFilterPage implements OnInit {
getcitylist() {
...
selectedDealIn: string[]=[];
  ...
  search() {
    ...
    this.router.navigate(['/machinery-exporters-listing'], {
      queryParams: {
