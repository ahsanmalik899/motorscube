...
@Component({
  selector: 'app-machinery-importer-filter',
  templateUrl: './machinery-importer-filter.page.html',
  styleUrls: ['./machinery-importer-filter.page.scss'],
  standalone:false,
})
export class MachineryImporterFilterPage implements OnInit {
...
back() {
  ...
  search() {
    ...
    this.router.navigate(['/machinery-importers-listing'], {
      queryParams: {
