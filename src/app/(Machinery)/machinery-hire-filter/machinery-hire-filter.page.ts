...
@Component({
  selector: 'app-machinery-hire-filter',
  templateUrl: './machinery-hire-filter.page.html',
  styleUrls: ['./machinery-hire-filter.page.scss'],
  standalone:false,
})
export class MachineryHireFilterPage implements OnInit {
