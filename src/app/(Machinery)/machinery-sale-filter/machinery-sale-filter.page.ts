...
@Component({
  selector: 'app-machinery-sale-filter',
  templateUrl: './machinery-sale-filter.page.html',
  styleUrls: ['./machinery-sale-filter.page.scss'],
  standalone:false,
})
export class MachinerySaleFilterPage implements OnInit {
...
updateHighMilageOptions() {
  ...
  getcitylist() {
      ...
      search() {
        ...
        this.route.navigate(['/machinery-sale-listing'], {
            queryParams: {
