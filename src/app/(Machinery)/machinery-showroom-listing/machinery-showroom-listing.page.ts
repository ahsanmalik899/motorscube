...
@Component({
  selector: 'app-machinery-showroom-listing',
  templateUrl: './machinery-showroom-listing.page.html',
  styleUrls: ['./machinery-showroom-listing.page.scss'],
  standalone:false,
})
export class MachineryShowroomListingPage implements OnInit {
  showroomData: any[] = [];
  filterData: any[] = [];
  selectedcon: any[] = [];
  selectedcity: any[] = [];
