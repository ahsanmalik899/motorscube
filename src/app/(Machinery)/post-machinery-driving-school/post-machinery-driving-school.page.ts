...
@Component({
  selector: 'app-post-machinery-driving-school',
  templateUrl: './post-machinery-driving-school.page.html',
  styleUrls: ['./post-machinery-driving-school.page.scss'],
  standalone:false,
})
export class PostMachineryDrivingSchoolPage implements OnInit {
...
userID: string |'';
  ...
  async saveUser(): Promise<void> {
    ...
    this.machineryservice.postDrivingSchool(formData).subscribe(
      (response) => {
