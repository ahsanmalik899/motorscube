...
@Component({
  selector: 'app-post-machinery-hire',
  templateUrl: './post-machinery-hire.page.html',
  styleUrls: ['./post-machinery-hire.page.scss'],
  standalone:false,
})
export class PostMachineryHirePage implements OnInit {
  back() {
    history.back();
  }
