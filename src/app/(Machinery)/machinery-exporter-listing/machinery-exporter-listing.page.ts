...
@Component({
  selector: 'app-machinery-exporter-listing',
  templateUrl: './machinery-exporter-listing.page.html',
  styleUrls: ['./machinery-exporter-listing.page.scss'],
  standalone:false,
})
export class MachineryExporterListingPage implements OnInit {
  exporterData: any[] = [];
  filterData: any[] = [];
  selectedcon: any[] = [];
  selectedcity: any[] = [];
