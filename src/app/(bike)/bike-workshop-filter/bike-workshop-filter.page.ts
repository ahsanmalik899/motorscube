...
@Component({
  selector: 'app-bike-workshop-filter',
  templateUrl: './bike-workshop-filter.page.html',
  styleUrls: ['./bike-workshop-filter.page.scss'],
  standalone:false,
})
export class BikeWorkshopFilterPage implements OnInit {
