...
@Component({
  selector: 'app-bike-leasing-filter',
  templateUrl: './bike-leasing-filter.page.html',
  styleUrls: ['./bike-leasing-filter.page.scss'],
  standalone:false,
})
export class BikeLeasingFilterPage implements OnInit {
