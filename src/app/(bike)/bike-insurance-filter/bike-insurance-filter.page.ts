...
@Component({
  selector: 'app-bike-insurance-filter',
  templateUrl: './bike-insurance-filter.page.html',
  styleUrls: ['./bike-insurance-filter.page.scss'],
  standalone:false,
})
export class BikeInsuranceFilterPage implements OnInit {
getcitylist() {
