...
@Component({
  selector: 'app-bike-post-exporter-busness',
  templateUrl: './bike-post-exporter-busness.page.html',
  styleUrls: ['./bike-post-exporter-busness.page.scss'],
  standalone:false,
})
export class BikePostExporterBusnessPage implements OnInit {
  ...
  back() {
    ...
    async submitFormData(): Promise<void> {
      ...
      this.bikeService.postExporterBusiness(formData).subscribe(
        (response) => {
