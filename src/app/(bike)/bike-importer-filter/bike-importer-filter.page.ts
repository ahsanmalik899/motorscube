...
@Component({
  selector: 'app-bike-importer-filter',
  templateUrl: './bike-importer-filter.page.html',
  styleUrls: ['./bike-importer-filter.page.scss'],
  standalone:false,
})
export class BikeImporterFilterPage implements OnInit {
