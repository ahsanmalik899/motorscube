...
@Component({
  selector: 'app-bike-exporter-filter',
  templateUrl: './bike-exporter-filter.page.html',
  styleUrls: ['./bike-exporter-filter.page.scss'],
  standalone:false,
})
export class BikeExporterFilterPage implements OnInit {
getcitylist() {
