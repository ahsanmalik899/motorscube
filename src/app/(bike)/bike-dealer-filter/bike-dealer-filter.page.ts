...
@Component({
  selector: 'app-bike-dealer-filter',
  templateUrl: './bike-dealer-filter.page.html',
  styleUrls: ['./bike-dealer-filter.page.scss'],
  standalone:false,
})
export class BikeDealerFilterPage implements OnInit {
back() {
  window.history.back();
}
getcitylist() {
