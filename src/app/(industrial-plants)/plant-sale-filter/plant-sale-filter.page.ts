...
@Component({
  selector: 'app-plant-sale-filter',
  templateUrl: './plant-sale-filter.page.html',
  styleUrls: ['./plant-sale-filter.page.scss'],
  standalone:false,
})
export class PlantSaleFilterPage implements OnInit {
...
engineSizes: number[] = [100, 500, 1000, 2000, 5000, 10000];
  ...
  constructor(public route: Router,private cdRef: ChangeDetectorRef, private popoverController: PopoverController, private userService: UserService,private plantservice:PlantsService) {
...
updateHighMilageOptions() {
  ...
  getcitylist() {
      ...
      search() {
        ...
        this.route.navigate(['/plant-sale-listing'], {
            queryParams: {
...
fetchMakes() {
  this,this.plantservice.getMakes().subscribe({
