...
@Component({
  selector: 'app-plant-hire-single-view',
  templateUrl: './plant-hire-single-view.page.html',
  styleUrls: ['./plant-hire-single-view.page.scss'],
  standalone:false,
})
export class PlantHireSingleViewPage implements OnInit {
