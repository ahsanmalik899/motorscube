...
@Component({
  selector: 'app-plant-workshop-filter',
  templateUrl: './plant-workshop-filter.page.html',
  styleUrls: ['./plant-workshop-filter.page.scss'],
  standalone:false,
})
export class PlantWorkshopFilterPage implements OnInit {
