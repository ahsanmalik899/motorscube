...
export class MyPlantsPage implements OnInit {
  ...
  throw new Error('Method not implemented.');
    ...
    showupgradebutton= false;
      ...
      constructor(private router: Router, 
        private planservice:PlantsService, 
  ...
  async buttonOneAction(id: string, saletype: string) {
    ...
    async editSale(id: any){
      this.router.navigate(['/update-plant-sale'], {
        queryParams: {
          adsId: id,
        }
      });
    ...
    async editHire(id: any){
      this.router.navigate(['/update-plant-hire'], {
        queryParams: {
          adsId: id,
        }
      });
    ...
    async fetchCarSale() {
      ...
      this.planservice.getPlantSale().subscribe({
        next: (data) => {
    ...
    async fetchcarHire() {
      const loader = await this.showLoader();
      this.planservice.getPlantHire().subscribe({
        next: (data) => {
    ...
    async deleteItem() {
      ...
      this.planservice.plantDeleteAds(formData).subscribe(
        (response) => {
