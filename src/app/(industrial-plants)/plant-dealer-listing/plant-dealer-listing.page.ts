...
@Component({
  selector: 'app-plant-dealer-listing',
  templateUrl: './plant-dealer-listing.page.html',
  styleUrls: ['./plant-dealer-listing.page.scss'],
  standalone:false,
})
export class PlantDealerListingPage implements OnInit {
