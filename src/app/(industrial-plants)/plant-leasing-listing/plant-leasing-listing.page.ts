...
@Component({
  selector: 'app-plant-leasing-listing',
  templateUrl: './plant-leasing-listing.page.html',
  styleUrls: ['./plant-leasing-listing.page.scss'],
  standalone:false,
})
export class PlantLeasingListingPage implements OnInit {
