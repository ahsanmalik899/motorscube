...
@Component({
  selector: 'app-update-plant-hire',
  templateUrl: './update-plant-hire.page.html',
  styleUrls: ['./update-plant-hire.page.scss'],
  standalone:false,
})
export class UpdatePlantHirePage implements OnInit {
