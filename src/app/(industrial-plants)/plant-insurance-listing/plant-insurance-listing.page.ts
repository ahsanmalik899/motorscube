...
@Component({
  selector: 'app-plant-insurance-listing',
  templateUrl: './plant-insurance-listing.page.html',
  styleUrls: ['./plant-insurance-listing.page.scss'],
  standalone:false,
})
export class PlantInsuranceListingPage implements OnInit {
  insuranceData: any[] = [];
  selectedcon: string[] = [];
  selectedcity: string[] = [];
  dealershipData: any[] = [];
