...
@Component({
  selector: 'app-plant-sale-single-view',
  templateUrl: './plant-sale-single-view.page.html',
  styleUrls: ['./plant-sale-single-view.page.scss'],
  standalone:false,
})
export class PlantSaleSingleViewPage implements OnInit {
