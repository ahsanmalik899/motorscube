...
@Component({
  selector: 'app-plant-leasing-single-view',
  templateUrl: './plant-leasing-single-view.page.html',
  styleUrls: ['./plant-leasing-single-view.page.scss'],
  standalone:false,
})
export class PlantLeasingSingleViewPage implements OnInit {
  ...
  filterCarData() {
    ...
    this.filterData = this.leasingData.filter(car =>
      (leasingId.length === 0 || leasingId === car.plant_leasing_ad_sale_id)
    );
