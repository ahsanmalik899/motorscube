...
@Component({
  selector: 'app-post-plant-exporter',
  templateUrl: './post-plant-exporter.page.html',
  styleUrls: ['./post-plant-exporter.page.scss'],
  standalone:false,
})
export class PostPlantExporterPage implements OnInit {
...
async submitFormData(): Promise<void> {
  ...
  this.plantservice.postExporterBusiness(formData).subscribe(
    (response) => {
