...
@Component({
  selector: 'app-plant-leasing-filter',
  templateUrl: './plant-leasing-filter.page.html',
  styleUrls: ['./plant-leasing-filter.page.scss'],
  standalone:false,
})
export class PlantLeasingFilterPage implements OnInit {
