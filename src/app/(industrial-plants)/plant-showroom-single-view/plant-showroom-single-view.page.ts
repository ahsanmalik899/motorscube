...
@Component({
  selector: 'app-plant-showroom-single-view',
  templateUrl: './plant-showroom-single-view.page.html',
  styleUrls: ['./plant-showroom-single-view.page.scss'],
  standalone:false,
})
export class PlantShowroomSingleViewPage implements OnInit {
...
filterCarData() {
  ...
  this.filterData = this.showroomData.filter((car) => {
    return showroomId.length === 0 || car.plant_showroom_ad_sale_id === showroomId;
  });
