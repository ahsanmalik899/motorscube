...
@Component({
  selector: 'app-post-plant-dealer',
  templateUrl: './post-plant-dealer.page.html',
  styleUrls: ['./post-plant-dealer.page.scss'],
  standalone:false,
})
export class PostPlantDealerPage implements OnInit {
