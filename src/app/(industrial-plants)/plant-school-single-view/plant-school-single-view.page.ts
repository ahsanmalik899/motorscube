...
@Component({
  selector: 'app-plant-school-single-view',
  templateUrl: './plant-school-single-view.page.html',
  styleUrls: ['./plant-school-single-view.page.scss'],
  standalone:false,
})
export class PlantSchoolSingleViewPage implements OnInit {
  ...
  filterCarData() {
    ...
    if (typeof schoolId === 'string' ) {
      ...
      this.filterData = this.schoolData.filter(school =>
        school.plant_school_ad_sale_id === schoolId // Direct comparison
      );
    } else {
