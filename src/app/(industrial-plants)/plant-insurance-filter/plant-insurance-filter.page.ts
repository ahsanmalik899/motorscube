...
@Component({
  selector: 'app-plant-insurance-filter',
  templateUrl: './plant-insurance-filter.page.html',
  styleUrls: ['./plant-insurance-filter.page.scss'],
  standalone:false,
})
export class PlantInsuranceFilterPage implements OnInit {
