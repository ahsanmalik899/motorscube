...
@Component({
  selector: 'app-vehicle-showroom-filter',
  templateUrl: './vehicle-showroom-filter.page.html',
  styleUrls: ['./vehicle-showroom-filter.page.scss'],
  standalone:false,
})
export class VehicleShowroomFilterPage implements OnInit {
getcitylist() {
