...
@Component({
  selector: 'app-update-vehicle-workshop',
  templateUrl: './update-vehicle-workshop.page.html',
  styleUrls: ['./update-vehicle-workshop.page.scss'],
  standalone:false,
})
export class UpdateVehicleWorkshopPage implements OnInit {
