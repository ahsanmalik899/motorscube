...
@Component({
  selector: 'app-update-vehicle-showroom',
  templateUrl: './update-vehicle-showroom.page.html',
  styleUrls: ['./update-vehicle-showroom.page.scss'],
  standalone:false,
})
export class UpdateVehicleShowroomPage implements OnInit {
