...
@Component({
  selector: 'app-vehicle-workshop-singleview',
  templateUrl: './vehicle-workshop-singleview.page.html',
  styleUrls: ['./vehicle-workshop-singleview.page.scss'],
  standalone:false,
})
export class VehicleWorkshopSingleviewPage implements OnInit {
