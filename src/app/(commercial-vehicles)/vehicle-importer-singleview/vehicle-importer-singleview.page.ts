...
@Component({
  selector: 'app-vehicle-importer-singleview',
  templateUrl: './vehicle-importer-singleview.page.html',
  styleUrls: ['./vehicle-importer-singleview.page.scss'],
  standalone:false,
})
export class VehicleImporterSingleviewPage implements OnInit {
