...
@Component({
  selector: 'app-post-vehicle-hire',
  templateUrl: './post-vehicle-hire.page.html',
  styleUrls: ['./post-vehicle-hire.page.scss'],
  standalone: false,
})
export class PostVehicleHirePage implements OnInit {
  back() {
    history.back();
  }
