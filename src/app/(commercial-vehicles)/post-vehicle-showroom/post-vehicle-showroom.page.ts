...
@Component({
  selector: 'app-post-vehicle-showroom',
  templateUrl: './post-vehicle-showroom.page.html',
  styleUrls: ['./post-vehicle-showroom.page.scss'],
  standalone:false,
})
export class PostVehicleShowroomPage implements OnInit {
