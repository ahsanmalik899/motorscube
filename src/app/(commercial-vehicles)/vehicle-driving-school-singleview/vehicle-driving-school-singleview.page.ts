...
@Component({
  selector: 'app-vehicle-driving-school-singleview',
  templateUrl: './vehicle-driving-school-singleview.page.html',
  styleUrls: ['./vehicle-driving-school-singleview.page.scss'],
  standalone:false,
})
export class VehicleDrivingSchoolSingleviewPage implements OnInit {
  isReadMore = true;
