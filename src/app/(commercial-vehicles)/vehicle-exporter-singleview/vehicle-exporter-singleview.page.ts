...
@Component({
  selector: 'app-vehicle-exporter-singleview',
  templateUrl: './vehicle-exporter-singleview.page.html',
  styleUrls: ['./vehicle-exporter-singleview.page.scss'],
  standalone:false,
})
export class VehicleExporterSingleviewPage implements OnInit {
