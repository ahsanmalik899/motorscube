...
@Component({
  selector: 'app-vehicle-sale-single-view',
  templateUrl: './vehicle-sale-single-view.page.html',
  styleUrls: ['./vehicle-sale-single-view.page.scss'],
  standalone:false,
})
export class VehicleSaleSingleViewPage implements OnInit {
  ...
  fetchCarSale() {
    this.commercialservice.getSinglevehicleSale(this.saleID).subscribe({
      next: (data: any[]) => {
