...
@Component({
  selector: 'app-post-vehicle-sale-ad',
  templateUrl: './post-vehicle-sale-ad.page.html',
  styleUrls: ['./post-vehicle-sale-ad.page.scss'],
  standalone:false,
})
export class PostVehicleSaleAdPage implements OnInit {
  selectedCity: string = '';
  selectedMake: string = '';
  selectedYear: any = '';
