...
@Component({
  selector: 'app-vehicle-leasing-singleview',
  templateUrl: './vehicle-leasing-singleview.page.html',
  styleUrls: ['./vehicle-leasing-singleview.page.scss'],
  standalone:false,
})
export class VehicleLeasingSingleviewPage implements OnInit {
  isReadMore = true;
