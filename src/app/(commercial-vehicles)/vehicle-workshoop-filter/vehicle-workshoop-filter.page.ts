...
@Component({
  selector: 'app-vehicle-workshoop-filter',
  templateUrl: './vehicle-workshoop-filter.page.html',
  styleUrls: ['./vehicle-workshoop-filter.page.scss'],
  standalone:false,
})
export class VehicleWorkshoopFilterPage implements OnInit {
...
resetAll() {
  ...
  search() {
    ...
    this.router.navigate(['/vehicle-workshoop-listing'], {
      queryParams: {
