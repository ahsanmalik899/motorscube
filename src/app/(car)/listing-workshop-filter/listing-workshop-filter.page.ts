...
@Component({
    selector: 'app-listing-workshop-filter',
    templateUrl: './listing-workshop-filter.page.html',
    styleUrls: ['./listing-workshop-filter.page.scss'],
    standalone: false
})
export class ListingWorkshopFilterPage implements OnInit {
getcitylist() {
