...
@Component({
    selector: 'app-update-insurance-busines',
    templateUrl: './update-insurance-busines.page.html',
    styleUrls: ['./update-insurance-busines.page.scss'],
    standalone: false
})
export class UpdateInsuranceBusinesPage implements OnInit {
back() {
  history.back()
}
    InsuranceFeatured='';
