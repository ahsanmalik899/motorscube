...
@Component({
    selector: 'app-post-workshop-busines',
    templateUrl: './post-workshop-busines.page.html',
    styleUrls: ['./post-workshop-busines.page.scss'],
    standalone: false
})
export class PostWorkshopBusinesPage implements OnInit {
back() {
history.back();
}
userID: string |'';
