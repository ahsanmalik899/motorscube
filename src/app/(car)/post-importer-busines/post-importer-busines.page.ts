...
@Component({
    selector: 'app-post-importer-busines',
    templateUrl: './post-importer-busines.page.html',
    styleUrls: ['./post-importer-busines.page.scss'],
    standalone: false
})
export class PostImporterBusinesPage implements OnInit {
back() {
history.back();
}
