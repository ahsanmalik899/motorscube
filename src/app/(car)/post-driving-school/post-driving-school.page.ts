...
@Component({
    selector: 'app-post-driving-school',
    templateUrl: './post-driving-school.page.html',
    styleUrls: ['./post-driving-school.page.scss'],
    standalone: false
})
export class PostDrivingSchoolPage implements OnInit {
