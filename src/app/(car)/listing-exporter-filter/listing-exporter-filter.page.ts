...
@Component({
    selector: 'app-listing-exporter-filter',
    templateUrl: './listing-exporter-filter.page.html',
    styleUrls: ['./listing-exporter-filter.page.scss'],
    standalone: false
})
export class ListingExporterFilterPage implements OnInit {
getcitylist() {
