...
import { Router } from '@angular/router';
  @Component({
    selector: 'app-update-exporter-busines',
    templateUrl: './update-exporter-busines.page.html',
    styleUrls: ['./update-exporter-busines.page.scss'],
    standalone: false
})
  export class UpdateExporterBusinesPage implements OnInit {
back() {
  history.back()
}
