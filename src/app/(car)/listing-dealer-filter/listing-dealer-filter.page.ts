...
@Component({
    selector: 'app-listing-dealer-filter',
    templateUrl: './listing-dealer-filter.page.html',
    styleUrls: ['./listing-dealer-filter.page.scss'],
    standalone: false
})
export class ListingDealerFilterPage implements OnInit {
back() {
  window.history.back();
}
getcitylist() {
