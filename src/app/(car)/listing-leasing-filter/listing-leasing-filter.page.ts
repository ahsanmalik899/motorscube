...
@Component({
    selector: 'app-listing-leasing-filter',
    templateUrl: './listing-leasing-filter.page.html',
    styleUrls: ['./listing-leasing-filter.page.scss'],
    standalone: false
})
export class ListingLeasingFilterPage implements OnInit {
back() {
  window.history.back();
}
getcitylist() {
