...
@Component({
    selector: 'app-post-exporter-busines',
    templateUrl: './post-exporter-busines.page.html',
    styleUrls: ['./post-exporter-busines.page.scss'],
    standalone: false
})
export class PostExporterBusinesPage implements OnInit {
back() {
history.back();
}
userID: string |'';
