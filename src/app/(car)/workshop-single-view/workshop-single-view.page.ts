...
@Component({
    selector: 'app-workshop-single-view',
    templateUrl: './workshop-single-view.page.html',
    styleUrls: ['./workshop-single-view.page.scss'],
    standalone: false
})
export class WorkshopSingleViewPage implements OnInit {
  isReadMore = true;
  ...
  filterCarData() {
    ...
    this.filterData = this.workshopData.filter(car => {
      ...
      return workshopId && workshopId === car.car_workshop_ad_sale_id.toString();
    });
