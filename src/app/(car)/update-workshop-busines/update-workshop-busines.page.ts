...
import { Router } from '@angular/router';
  @Component({
    selector: 'app-update-workshop-busines',
    templateUrl: './update-workshop-busines.page.html',
    styleUrls: ['./update-workshop-busines.page.scss'],
    standalone: false
})
  export class UpdateWorkshopBusinesPage implements OnInit {
back() {
  history.back()
}
    WorkshopFeatured='';
