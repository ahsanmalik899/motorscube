  ...
  @Component({
    selector: 'app-hire-filters',
    templateUrl: './hire-filters.page.html',
    styleUrls: ['./hire-filters.page.scss'],
    standalone: false
})
  export class HireFiltersPage implements OnInit {
