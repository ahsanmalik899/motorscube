...
@Component({
    selector: 'app-listing-insurance-filter',
    templateUrl: './listing-insurance-filter.page.html',
    styleUrls: ['./listing-insurance-filter.page.scss'],
    standalone: false
})
export class ListingInsuranceFilterPage implements OnInit {
getcitylist() {
