...
@Component({
    selector: 'app-update-school-busines',
    templateUrl: './update-school-busines.page.html',
    styleUrls: ['./update-school-busines.page.scss'],
    standalone: false
})
export class UpdateSchoolBusinesPage implements OnInit {
back() {
  history.back()
}
