...
@Component({
    selector: 'app-listing-drv-school-filter',
    templateUrl: './listing-drv-school-filter.page.html',
    styleUrls: ['./listing-drv-school-filter.page.scss'],
    standalone: false
})
export class ListingDrvSchoolFilterPage implements OnInit {
getcitylist() {
