...
@Component({
    selector: 'app-post-insurance-busines',
    templateUrl: './post-insurance-busines.page.html',
    styleUrls: ['./post-insurance-busines.page.scss'],
    standalone: false
})
export class PostInsuranceBusinesPage implements OnInit {
back() {
history.back();
}
