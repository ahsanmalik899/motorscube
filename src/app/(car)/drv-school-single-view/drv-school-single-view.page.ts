...
@Component({
    selector: 'app-drv-school-single-view',
    templateUrl: './drv-school-single-view.page.html',
    styleUrls: ['./drv-school-single-view.page.scss'],
    standalone: false
})
export class DrvSchoolSingleViewPage implements OnInit {
  isReadMore = true;
  ...
  filterCarData() {
    ...
    if (typeof schoolId === 'string' ) {
      ...
      this.filterData = this.schoolData.filter(school =>
        school.car_school_ad_sale_id === schoolId // Direct comparison
      );
    } else {
