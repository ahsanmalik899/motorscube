...
@Component({
    selector: 'app-showroom-single-view',
    templateUrl: './showroom-single-view.page.html',
    styleUrls: ['./showroom-single-view.page.scss'],
    standalone: false
})
export class ShowroomSingleViewPage implements OnInit {
  isReadMore = true;
...
filterCarData() {
  ...
  this.filterData = this.showroomData.filter((car) => {
    return showroomId.length === 0 || car.car_showroom_ad_sale_id === showroomId;
  });
