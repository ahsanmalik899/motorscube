...
@Component({
    selector: 'app-post-dealer-busines',
    templateUrl: './post-dealer-busines.page.html',
    styleUrls: ['./post-dealer-busines.page.scss'],
    standalone: false
})

export class PostDealerBusinesPage implements OnInit {
  userID: string |'';
back() {
  history.back()
}
