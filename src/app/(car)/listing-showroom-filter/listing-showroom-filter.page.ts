...
@Component({
    selector: 'app-listing-showroom-filter',
    templateUrl: './listing-showroom-filter.page.html',
    styleUrls: ['./listing-showroom-filter.page.scss'],
    standalone: false
})
export class ListingShowroomFilterPage implements OnInit {
getcitylist() {
