...
@Component({
    selector: 'app-post-showroom-busines',
    templateUrl: './post-showroom-busines.page.html',
    styleUrls: ['./post-showroom-busines.page.scss'],
    standalone: false
})
export class PostShowroomBusinesPage implements OnInit {
back() {
history.back();
}
userID: string |'';
